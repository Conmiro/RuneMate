...
public class OpenBot extends TaskScript implements EmbeddableUI {
    private String status = "Starting bot";
    private StopWatch runtime = new StopWatch();
    private LoopingThread halfSecondLoopingThread;
    private List<Runnable> loopingThreadRunnables = new ArrayList<>();
    ...
    public final void onStart(String... args) {
        ...
        //Run the onStart the bot specifies
        onStart();
    }
    ...
    public void setStatus(String status) {
        ...
        if (botInterfaceProperty().get() != null) {
            botInterfaceProperty().get().setStatus(status);
        }
    }
    ...
    public String getNpcName(int id) {
        ...
        if (name == null) {
            ...
            if (def != null) {
                //Set name to the name in the definition and add it to the map
                name = def.getName();
