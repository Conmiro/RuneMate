...
public class InterfaceTreeItem extends TreeItem<String> {
    ...
    public String getInformation() {
        ...
        if (container != null) {
            ...
            lines.add("Components: " + component.getComponents().size());
            ...
            lines.add("Content Type: " + component.getContentType());
            lines.add("Border Thickness: " + component.getBorderThickness());
            lines.add("Texture Id: " + component.getTextureId());
            ...
            if (player != null) {
                ...
                lines.add("Npc Id: " + player.getNpcId());
